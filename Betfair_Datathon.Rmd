...
prediction_df <- tibble(df_test$team_1, df_test$team_2, prediction_stacked$data$prob.win, prediction_stacked$data$prob.draw, prediction_stacked$data$prob.lose)
