...
h2o.init()
h2ogbm_tc = makeTuneControlMBO(budget=100)
...
logtablewc <- logtablewc %>% add_row(comments = "full set with ELO ratings, data to 20180609", CV = "4 x world cup rounds only, growing window", learner = "h2o deeplearning tuned 1 round", mmce = 0.4453125, accuracy = 0.5546875, logloss = 1.0356291)
