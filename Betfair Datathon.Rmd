...
#remove transitory columns from the main DF
df <- df %>% select(-ends_with("_stage"))
>>>>>>> 547218c1400cf4488ac4226b3ac8157baaf7ddab

<<<<<<< HEAD
#df <- df %>% select(-starts_with("match"))
||||||| merged common ancestors
=======
#df %>% select(starts_with("team_1_rolling")) %>% tail
>>>>>>> 547218c1400cf4488ac4226b3ac8157baaf7ddab
...
||||||| merged common ancestors
=======
#df <- df %>% select(-starts_with("team_1_rolling"))
>>>>>>> 547218c1400cf4488ac4226b3ac8157baaf7ddab
...
<<<<<<< HEAD
#df %>% select(ends_with("50_goals"), ends_with("50_outcome")) %>% tail
||||||| merged common ancestors
for(g in lst) {
=======
>>>>>>> 547218c1400cf4488ac4226b3ac8157baaf7ddab
